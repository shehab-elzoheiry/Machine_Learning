...
### This repository will be gathering all my scripts for building models:
  ...
  The built models are logistic regression, decision tree, K-nearest neighbors and support-vector machine. They were optimized to achieve highest accuracy score, which was then compared accross models to identify the best for this dataset.
